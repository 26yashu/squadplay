...
export function CountdownTimer({ timeRemaining, duration }) {
  ...
  return (
    <motion.div 
      ...
      className={`flex items-center justify-center w-full max-w-[200px] h-16 rounded-full border-2 ${colorClass} bg-black/60 mx-auto mb-6`}
    >
      <span className="text-3xl font-black">{timeRemaining}s</span>
    </motion.div>
  );
}
