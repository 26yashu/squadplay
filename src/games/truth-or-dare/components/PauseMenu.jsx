  ...
  return (
    <div className="absolute inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-6">
      ...
      >
        ...
        <h2 className="text-3xl font-bold mb-8 text-hyper-pink">Paused</h2>
        <div className="flex flex-col gap-4">
          <Button onClick={onResume} className="w-full py-4 text-lg bg-hyper-pink hover:bg-pink-600">
          ...
          <Button onClick={onQuit} variant="secondary" className="w-full text-crimson-error border-crimson-error/30 hover:bg-crimson-error/10">
            <LogOut size={20} className="mr-2 inline" /> Quit to Results
          </Button>
        </div>
      </motion.div>
    </div>
